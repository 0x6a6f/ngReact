...
> **Fork: this Fork changes the ESM template of [ngReact](https://github.com/ngReact/ngReact) to be consistant with those generated by [Babel](https://github.com/babel/babel) and used by [React](https://github.com/facebook/react).**
